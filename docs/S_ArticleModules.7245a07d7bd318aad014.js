...
/* harmony import */ var _database_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(90);
var currentarticleid = localStorage.getItem('currentarticleid');


var article;
if (document.getElementById('ArticlesModules')) {
  (0,_database_js__WEBPACK_IMPORTED_MODULE_1__/* .getArticlesData */ .q)().then(function (array) {
    SetArticle(array);
    RenderArticle();
  });
}
...
function RenderArticle() {
  ...
  var newChapters = document.createElement('div');
