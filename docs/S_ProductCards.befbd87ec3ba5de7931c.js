...
(() => {
"use strict";
/* harmony import */ var _database_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(90);

var items = [];
(0,_database_js__WEBPACK_IMPORTED_MODULE_0__/* .getItemsData */ .z)().then(function (array) {
  items = array;
  SetPopProductCards();
  SetAltProductCards();
});
function SetPopProductCards() {
  if (document.getElementById('PopularItems')) {
    for (var index = 0; index < 10; index++) {
      ...
      var MarkIconClass = 'MarkIcon danger';
      var MarkTextClass = "MarkText danger";
      var MarkText = 'чем опасен';
      var Mark = 'A_Mark danger';
      newElement.innerHTML = "\n    <div class='".concat(Mark, "'>\n          <div class=\"").concat(MarkIconClass, "\"></div>\n          <p class=\"").concat(MarkTextClass, "\">").concat(MarkText, "</p>\n        </div>\n\n        <div class = 'W_ProdCard'>\n        <img src='").concat(items[index].image[0].url, "' class=\"A_ItemImage\"/>\n        </div>\n\n        <p class=\"A_ItemName short\">").concat(items[index].name, "</p>\n\n        <div class=\"M_ItemInfo hide\"> ").concat(items[index].data, "\n          \n        </div>\n    ");
...
function CardsSides() {
  var ProdCardInfoButtons = document.getElementsByClassName('A_Mark');
  var _loop = function _loop() {
    var element = ProdCardInfoButtons[index];
  ...
  for (var index = 0; index < ProdCardInfoButtons.length; index++) {
    _loop();
  }
}
function SetAltProductCards() {
  if (document.getElementById('PopularItems')) {
    for (var index = 0; index < 10; index++) {
      var newElement = document.createElement('div');
      newElement.classList = 'O_ProductCard';
      var MarkIconClass = 'MarkIcon safe';
      var MarkTextClass = "MarkText safe";
      var MarkText = 'безопасен';
      var Mark = 'A_Mark safe';
      newElement.innerHTML = "\n    <div class='".concat(Mark, "'>\n          <div class=\"").concat(MarkIconClass, "\"></div>\n          <p class=\"").concat(MarkTextClass, "\">").concat(MarkText, "</p>\n        </div>\n\n        <div class = 'W_ProdCard'>\n        <img src='").concat(items[index].image[0].url, "' class=\"A_ItemImage\"/>\n        </div>\n\n        <p class=\"A_ItemName short\">").concat(items[index].name, "</p>\n          \n        </div>\n    ");
