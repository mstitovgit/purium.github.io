...
/* harmony export */   q: () => (/* binding */ getArticlesData)
/* harmony export */ });
/* unused harmony export getItemsData */
...
var CategoryItems = document.getElementsByClassName('M_CategoryItem');
var CategoryItemsContainer = document.getElementById('O_CategoryItemsContainer');
var CategoryFilterButton = document.getElementById('CategoryFilterButton');
var W_Filter = document.getElementById('W_Filter');
var filtertag = 'all';
var articles = [];
var cards = [];
var currentarticleid;
SetFilter();
(0,_database_js__WEBPACK_IMPORTED_MODULE_0__/* .getArticlesData */ .q)().then(function (array) {
  ...
  var _loop = function _loop() {
    ...
    element.addEventListener('click', function () {
      if (element.classList == 'M_CategoryItem button closed') {
        ...
        var icon = element.firstElementChild.classList;
  ...
  if (document.getElementById('AllArticlesContainer')) {
    for (var index = 0; index < articles.length; index++) {
      if (articles[index].tags.includes(filtertag) || filtertag == 'all') {
        ...
        var M_ArticleCardclass = 'M_ArticleCard';
        if (articles[index].iswhite) {
          M_ArticleCardclass = 'M_ArticleCard white';
        }
        newElement.classList = 'ablock';
        newElement.setAttribute('id', "".concat(articles[index].id));
        newElement.setAttribute('href', "article.html");
        newElement.innerHTML = "<div class=\"".concat(M_ArticleCardclass, "\" style = \"background-image: url('").concat(articles[index].image[0].url, "')\"></div>");
